			...
			$this.audio.on('canplay',function () {
				...
				if (dataLrc != currentLrc) {
					...
					$this.dom.lrc.animate({
						scrollTop:top + positionTop - $this.settings.lrcTopPos - $this.settings.lrcTopPos - $this.settings.lrcTopPos - $this.settings.lrcTopPos - $this.settings.lrcTopPos - $this.settings.lrcTopPos - $this.settings.lrcTopPos
					},200);
				}
				// 触发onTimeUpdate事件
